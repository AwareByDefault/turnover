...
- The raw instance is cached first, so re-entrant resolution during construction doesn't loop and (as in Spring AOP) self-invocation reaches the unwrapped object.
